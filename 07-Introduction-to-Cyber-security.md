...
Cyber attacks usually involve different techniques to trick users, steal information, or gain unauthorized access. Attackers may first collect information about a target and then use phishing, social engineering, credential attacks, or malware to compromise the system.
...
Your account has a security issue.
Please provide your password so I can fix it.
The attacker is not technically hacking the system. Instead, they are manipulating the person.
Common techniques include pretexting, baiting, impersonation, and tailgating.
Protection
